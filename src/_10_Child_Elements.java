...
public class _10_Child_Elements {
    public static void main(String[] args) {
        ...
        // List<WebElement> headerItems = driver.findElements(By.xpath("//ul[@id='comp-kuiqjiulitemsContainer']//a"));

        String[] expectedTexts = {"HOME", "APPLY NOW", "INTRO SESSION", "APPLY NOW", "COURSES", "CONTACT"};
